...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050816] p-4 text-white">
      <LandingBackground />

      <main className="glass-card-glow relative z-10 w-full max-w-md p-8">
        <div className="mb-8 flex flex-col items-center text-center">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#7c3aed] to-[#38bdf8] shadow-[0_0_32px_rgba(124,58,237,0.55)]">
            <Target className="h-6 w-6 text-white" />
          </div>
          <h1 className="text-2xl font-bold tracking-tight">
            Welcome back to <span className="gradient-text">LeadGen AI</span>
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="email" className="mb-1.5 block text-xs font-medium text-[#cbd5e1]">
              Work Email
            </label>
            <input
              id="email"
        ...
        <p className="mt-6 text-center text-sm text-[#94a3b8]">
          New to LeadGen AI?{" "}
          <Link href="/#signup" className="font-semibold text-[#a855f7] transition-colors hover:text-[#c084fc]">
